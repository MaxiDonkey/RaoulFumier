...
// PASTLWTR : 1.2
// File generated on 12/01/2019 03:43:41 from Type Library described below.
...
//   Hint: Symbol 'Type' renamed to 'type_'
//   Hint: Symbol 'Type' renamed to 'type_'
//   Error creating palette bitmap of (TSpObjectTokenCategory) : Indice de liste hors limites (148)
//   Error creating palette bitmap of (TSpObjectToken) : Indice de liste hors limites (154)
//   Error creating palette bitmap of (TSpMMAudioIn) : Indice de liste hors limites (169)
//   Error creating palette bitmap of (TSpMMAudioOut) : Indice de liste hors limites (182)
//   Error creating palette bitmap of (TSpVoice) : Indice de liste hors limites (186)
//   Error creating palette bitmap of (TSpSharedRecoContext) : Indice de liste hors limites (193)
//   Error creating palette bitmap of (TSpInprocRecognizer) : Indice de liste hors limites (235)
//   Error creating palette bitmap of (TSpSharedRecognizer) : Indice de liste hors limites (241)
//   Error creating palette bitmap of (TSpLexicon) : Indice de liste hors limites (242)
//   Error creating palette bitmap of (TSpUnCompressedLexicon) : Indice de liste hors limites (251)
//   Error creating palette bitmap of (TSpShortcut) : Indice de liste hors limites (253)
//   Error creating palette bitmap of (TSpPhoneConverter) : Indice de liste hors limites (258)
//   Error creating palette bitmap of (TSpPhoneticAlphabetConverter) : Indice de liste hors limites (260)
//   Error creating palette bitmap of (TSpTextSelectionInformation) : Indice de liste hors limites (263)
//   Error creating palette bitmap of (TSpPhraseInfoBuilder) : Indice de liste hors limites (264)
//   Error creating palette bitmap of (TSpAudioFormat) : Indice de liste hors limites (265)
//   Error creating palette bitmap of (TSpWaveFormatEx) : Indice de liste hors limites (266)
//   Error creating palette bitmap of (TSpInProcRecoContext) : Indice de liste hors limites (267)
//   Error creating palette bitmap of (TSpCustomStream) : Indice de liste hors limites (268)
//   Error creating palette bitmap of (TSpFileStream) : Indice de liste hors limites (269)
//   Error creating palette bitmap of (TSpMemoryStream) : Indice de liste hors limites (270)
// ************************************************************************ //
// *************************************************************************//
// NOTE:                                                                      
